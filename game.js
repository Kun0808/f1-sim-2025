...
const ACHIEVEMENTS = [
  ...
  { id: 'social_butterfly', name: '🤝 社交达人', desc: '与5位车手达到好友关系', icon: '🤝', rarity: 'common', check: (gs) => {
  ...
  { id: 'comeback_king', name: '🔄 逆转之王', desc: '从P10以后发车获胜', icon: '🔄', rarity: 'rare', check: (gs) => gs.comebackWin >= 1 },
  ...
  { id: 'best_friend', name: '💚 挚友', desc: '与一位车手达到挚友关系(80+)', icon: '💚', rarity: 'rare', check: (gs) => {
    if (!gs.driverRelationships) return false;
  ...
  { id: 'perfect_weekend', name: '✨ 完美周末', desc: '杆位+冠军+最快圈(需在代码中追踪)', icon: '✨', rarity: 'epic', check: (gs) => (gs.perfectWeekends || 0) >= 1 },
  ...
  { id: 'comeback_legend', name: '🌅 逆转传奇', desc: '从P15以后发车获胜', icon: '🌅', rarity: 'epic', check: (gs) => (gs.comebackWin || 0) >= 1 && gs.comebackFromPos <= 15 },
  ...
  { id: 'all_rounds', name: '🌍 赛季全勤完赛', desc: '单赛季全部24站完赛', icon: '🌍', rarity: 'legendary', check: (gs) => (gs.seasonFinishes || 0) >= 24 },
  { id: 'max_stat', name: '💯 极限突破', desc: '任意一项属性达到100(MAX)', icon: '💯', rarity: 'legendary', check: (gs) => {
